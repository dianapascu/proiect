...
int counter = 0;
int birthdayGreg[] = {5, 25};
int birthdayCate[] = {11, 5};
...
int HAPPY[]         = {144, 144, 144, 144, 144, 144, 144, 144, 144, 144, 144, 144};
int BIRTHDAY[]      = {144, 144, 144, 144, 144, 144, 144, 144, 144, 144, 144, 144};
int fix_bogdan[]    = {95,94,93,144,144,144,144,144,144,144,144,144};
...
void loop()
{
    ...
    checkBirthday(currentTime);
    if (isBirthday && counter < 100 && counter > 50)
    {
        displayBirthday();
    }
    else
 ...
 */
void checkBirthday(DateTime currentTime)
{
    if((currentTime.month() == birthdayGreg[0] && currentTime.day() == birthdayGreg[1])
    || (currentTime.month() == birthdayCate[0] && currentTime.day() == birthdayCate[1]))
    {
        isBirthday = true;
    }
    else
...
/**
 * Sets the Happy Birthday pixels to light up
 */
void displayBirthday()
{
    turnOnPixels(HAPPY);
    turnOnPixels(BIRTHDAY);
}
